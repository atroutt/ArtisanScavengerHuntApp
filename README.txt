...
1. HuntWriter -  this is a convenient NFC tag writer app that consumes the same data as the app. You can use any tag writer app you want, but this makes it easy to get your tags right for the app.
