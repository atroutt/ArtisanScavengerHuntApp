...
public class Hunt {
	...
	public static final int QUESTION_STATE_QUESTIONING = 1;
	 ...
	 * a difficulty group, so that, say, a hard clue can't proceed
	 * an easier clue.
	 * 
	...
	Hunt(String jsonString, Resources res, Context context) {
		...
		try {
			...
			for (int i = 0; i < length; i++) {
				...
				Clue clue = new Clue(clueObj.getString("id"), clueObj.getString("displayName"), clueObj.getString("displayText"), clueObj.getString("displayImage"));
